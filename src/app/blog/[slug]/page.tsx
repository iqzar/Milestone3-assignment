    ...
    <main className="bg-slate-100">
      ...
      <div className="flex flex-wrap justify-between">
        ...
        <div id="right" className="w-full md:w-[30%]">
          <div className="w-full md:w-60 h-auto md:pt-10 ml-10 pl-5 pr-5 pb-5 mt-10 bg-white">
          ...
          <div className="w-full md:w-60 h-auto md:pt-5 ml-10 pl-5 pr-5 pb-2 mt-10 bg-white">
